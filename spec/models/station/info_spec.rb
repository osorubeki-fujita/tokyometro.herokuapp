...
RSpec.describe Station::Info, :type => :model do
  ...
  describe "Nakano-sakaue" do
    ...
    station_infos.each do | k , station_info |
      ...
      oedo = ::Railway::Line::Info.find_by( same_as: "odpt.Railway:Toei.Oedo" )
      ...
      it "has connecting railway line info to Toei Oedo Line" do
        c_to_oedo = c.find_by( railway_line_info_id: oedo.id )
      ...
      it "has connecting railway line info to Marunouchi #{ another_railway_line_key.capitalize } Line." do
        c_to_another = c.find_by( railway_line_info_id: another_railway_line.id )
  ...
  describe "Ayase" do
    ...
    it "includes information of Ayase Station on Chiyoda Main Line" do
      ...
      connecting_railway_line_info_of_chiyoda_branch = ayase_main.connecting_railway_line_infos.find_by( railway_line_info_id: chiyoda_branch.id )
      connecting_railway_line_info_of_jr_joban = ayase_main.connecting_railway_line_infos.find_by( railway_line_info_id: jr_joban.id )
    ...
    it "includes information of Ayase Station on Chiyoda Branch Line" do
      ...
      connecting_railway_line_info_of_chiyoda_main = ayase_branch.connecting_railway_line_infos.find_by( railway_line_info_id: chiyoda_main.id )
      connecting_railway_line_info_of_jr_joban = ayase_branch.connecting_railway_line_infos.find_by( railway_line_info_id: jr_joban.id )
