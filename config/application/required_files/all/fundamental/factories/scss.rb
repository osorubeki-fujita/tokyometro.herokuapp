class RailsTokyoMetro::Application::RequiredFiles::All::Fundamental::Factories::Scss < RailsTokyoMetro::Application::RequiredFiles

  def self.top_file
    ::File.join( ::Rails.root , "lib" , "tokyo_metro" , "factories" , "scss" )
  end
