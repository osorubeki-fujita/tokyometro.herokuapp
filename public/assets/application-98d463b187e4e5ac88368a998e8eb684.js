...
(function() {
  var StationGroup, StationMatrixRow;
...
(function() {
  ...
  Initializer = (function() {
    ...
    Initializer.prototype["do"] = function() {
      var document, fare_table, main_contents, now_developing_processor, passenger_survey_table, railway_line, railway_line_and_station_matrixes, railway_line_codes, real_time_info_processor, selection_header_processor, side_menu_processor, station_facility, station_timetables, top_content, train_informations, train_locations, twitters_processor;
...
(function() {
  var PassengerSurveyTable, PassengerSurveyTableRow;

  PassengerSurveyTable = (function() {
    var first_station_code_image, max_number_of_station_code, max_width_of_station_codes, set_attributes_of_station_info, set_link_to_each_row, set_width_of_station_codes, tbody, tr_rows;
    ...
    set_width_of_station_codes = function(v) {
      var _width;
    ...
    PassengerSurveyTable.prototype.process = function() {
      set_width_of_station_codes(this);
  ...
  PassengerSurveyTableRow = (function() {
    var station_code_images, station_codes, station_info, station_info_domain;
    ...
    PassengerSurveyTableRow.prototype.set_width_of_station_codes = function(width_new) {
      station_codes(this).css('width', width_new);
    };

    PassengerSurveyTableRow.prototype.set_attributes_of_station_info = function() {
      var s;
      s = new StationInfoProcessor(station_info_domain(this));
      station_info_domain(this).css('height', s.max_outer_height_of_children(true));
      s.process();
