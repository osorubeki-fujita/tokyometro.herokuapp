...
(function() {
  ...
  OnPageLoadHandler = (function() {
    var initialize_google_maps_in_station_facility, list, process_normal_list, set_geo_location_info;
    ...
    OnPageLoadHandler.prototype.process_on_page_load = function() {
      ...
      set_geo_location_info(this);
      initialize_google_maps_in_station_facility(this);
    };
