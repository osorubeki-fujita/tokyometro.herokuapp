...
(function() {
  ...
  LinksToRailwayLinePages = (function() {
    ...
    max_height_of_link_domains = function(v) {
      var p;
    ...
    whole_height_of_link_domains = function(v) {
      var b_width, h, num;
    ...
    whole_height_of_title_domains = function(v) {
      var num, p1, _t;
      _t = title_domains(v);
      num = _t.length;
...
(function() {
  ...
  LinksToStationInfoPages = (function() {
    var columns, has_station_link_list, process_each_column, set_height_of_lists, station_link_list_en, station_link_list_ja;
...
(function() {
  var SideMenuEachLink, SideMenuProcessor;

  SideMenuProcessor = (function() {
    var links_to_documents, links_to_main_contents, links_to_other_websites, process_links_to_documents, process_links_to_main_contents, process_links_to_other_websites;

    function SideMenuProcessor(domain) {
    ...
    SideMenuProcessor.prototype.process = function() {
    ...
    process_links_to_main_contents = function(v) {
      links_to_main_contents(v).children('li').each(function() {
        var li;
    ...
    process_links_to_documents = function(v) {
      links_to_documents(v).children('li').each(function() {
        var li;
    ...
    process_links_to_other_websites = function(v) {
      links_to_other_websites(v).children('li').each(function() {
        var li;
...
(function() {
  ...
  FareTables = (function() {
    var has_table, process_each_fare_table, process_links_to_railway_line_pages, tables;
...
(function() {
  ...
  Initializer = (function() {
    ...
    Initializer.prototype.process = function() {
      var document, fare_table, links_to_station_info_pages, main_contents, now_developing_processor, passenger_survey, railway_line, railway_line_codes, railway_line_matrixes, real_time_info_processor, selection_header_processor, side_menu_processor, station_facility, station_matrixes, station_timetables, top_content, train_informations, train_locations, twitters_processor;
...
(function() {
  var LinksToPassengerSurveyPages, PassengerSurvey, PassengerSurveyTable, PassengerSurveyTableRow;

  PassengerSurvey = (function() {
    var has_table, passenger_survey_page, process_links_to_railway_line_pages, process_table, table;
    ...
    passenger_survey_page = function(v) {
  ...
  PassengerSurveyTable = (function() {
    ...
    additional_width_of_td_station_info = function(v) {
      var w, _margin_right_of_table, _max_td_graph_width, _min_additional_width_of_td_station_info;
  ...
  PassengerSurveyTableRow = (function() {
    ...
    function PassengerSurveyTableRow(row) {
      this.row = row;
    }
    ...
    PassengerSurveyTableRow.prototype.set_width_of_td_station_info = function(_additional_width_of_td_station_info) {
      var current_width, _station_info;
  ...
  LinksToPassengerSurveyPages = (function() {
    ...
    links_to_railway_line_pages_of_this_station = function(v) {
      return v.domain.children('ul#links_to_railway_line_pages_of_this_station');
    };

    links_to_railway_line_pages = function(v) {
    ...
    ul_each_railway_line_domains = function(v) {
      var ary;
      ary = [];
      $.each([links_to_railway_line_pages_of_this_station(v), links_to_railway_line_pages(v)], function() {
        var d;
        if ($(this).length > 0) {
    ...
    li_railway_line_domains = function(v) {
      var ary;
      ary = [];
    ...
    ul_operator_domains = function(v) {
      var d;
    ...
    li_tokyo_metro_domain = function(v) {
      var d, _ul_operator_domains;
    ...
    contents_of_railway_line_or_operator_domain = function(v) {
      var ary, _link_domains_to_operator_page;
      ary = [];
    ...
    li_survey_year_domains = function(v) {
      var ary, _ul_operator_domains;
      ary = [];
      $.each(ul_each_railway_line_domains(v), function() {
        $(this).children('li.survey_year').each(function() {
          ary.push($(this));
        });
      });
      _ul_operator_domains = ul_operator_domains(v);
    ...
    set_width_of_survey_year_domain = function(v) {
      var p, w, _li_survey_year_domains;
...
(function() {
  ...
  ContentHeaderProcessor = (function() {
    var font_awesome_icons, icon_domains, max_width_of_font_awesome_icons, process_each_domain, process_each_icon, width_of_icon_domains, width_of_icon_domains_new;
...
(function() {
  var ObserverOfStationFacilityPlatformInfoTab;
...
(function() {
  ...
  StationFacilityTabsAndContents = (function() {
    ...
    function StationFacilityTabsAndContents(platform_info_tabs, platform_info_tab_contents) {
    ...
    display_first_platform_info_tab = function(v, change_location) {
      var target, _anchor_name, _first_tab_id;
      if (change_location == null) {
        change_location = false;
      }
...
(function() {
  ...
  RailwayLine = (function() {
    var has_multiple_travel_time_info_tables, max_width_of_travel_time_info_tables, process_travel_time_info_tables, process_women_only_car, travel_time, travel_time_info;
    ...
    process_travel_time_info_tables = function(v) {
      ...
      travel_time_info(v).each(function() {
        var table;
        table = new TravelTimeInfoTable($(this));
        return table.set_width_of_station_info_domain();
      });
    };
...
(function() {
  ...
  StationTimetableTopHeaders = (function(_super) {
    var operation_day_domains, process_operation_day_domains;

    __extends(StationTimetableTopHeaders, _super);
  ...
  StationTimetableContentsOperationDayDomains = (function(_super) {
    var set_vertical_positions, set_widthes;

    __extends(StationTimetableContentsOperationDayDomains, _super);
  ...
  StationTimetableContentsOperationDayDomain = (function(_super) {
    var height, height_of_text, padding_top_and_bottom;

    __extends(StationTimetableContentsOperationDayDomain, _super);
  ...
  StationTimetableHours = (function(_super) {
    __extends(StationTimetableHours, _super);
  ...
  StationTimetableStationTrainTimes = (function(_super) {
    __extends(StationTimetableStationTrainTimes, _super);
  ...
  StationTimetableTrainTimesInEachHour = (function(_super) {
    var station_train_times;

    __extends(StationTimetableTrainTimesInEachHour, _super);
...
(function() {
  ...
  TrainInformations = (function() {
    ...
    max_width_of_icon_body = function(v) {
      ...
      informations(v).each(function() {
        var train_information, _icon_body_width;
        train_information = new TrainInformation($(this));
    ...
    initialize_size_of_railway_line_matrix_and_status = function(v) {
      var h, _size_of_railway_line_matrix, _size_of_status;
  ...
  TrainInformation = (function() {
    ...
    domain_height_new = function(v) {
      var border, _h, _railway_line_matrix;
    ...
    set_height_of_railway_line_matrix_and_status_and_set_margin = function(v) {
      var margin_top_and_bottom_of_status_info, status_outer_height, _max_outer_height;
      _max_outer_height = max_outer_height_of_railway_line_matrix_and_status(v);
      arrange_height_of_railway_line_matrix_and_status(v, _max_outer_height);
  ...
  TrainInformationRailwayLineMatrix = (function(_super) {
    ...
    __extends(TrainInformationRailwayLineMatrix, _super);
  ...
  TrainInformationStatus = (function(_super) {
    ...
    __extends(TrainInformationStatus, _super);
    ...
    TrainInformationStatus.prototype.initialize_icon_size = function(_max_width) {
      var margin_left_and_right, _icon_body_width;
...
(function() {
  ...
  TrainLocation = (function() {
    ...
    process_train_fundamental_infos = function(v) {
      var p, terminal_station, _terminal_station, _train_fundamental_infos, _train_infos;
    ...
    process_starting_station = function(v) {
      var p1, p2, ps, station_info, _starting_station;
...
(function() {
  ...
  TwittersProcessor = (function() {
    var content_header, function_for_embed_script, process_header;
