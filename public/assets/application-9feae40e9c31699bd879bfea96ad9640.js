...
(function() {
  ...
  PassengerSurveyTable = (function() {
    ...
    set_attributes_of_station_info = function(v) {
      return tr_rows(v).each(function() {
        var row;
        row = new PassengerSurveyTableRow($(this));
  ...
  PassengerSurveyTableRow = (function() {
    var station_code_images, station_codes, station_info, station_info_height_new, station_text;
    ...
    station_codes = function(v) {
      return station_info(v).children('.station_codes').first();
    };

    station_text = function(v) {
      return station_info(v).children('.text').first();
    };
    ...
    station_info_height_new = function(v) {
      var margin_bottom, margin_top;
      margin_top = 8;
      margin_bottom = 8;
      return Math.max(station_codes(v).outerHeight(true), station_text(v).outerHeight(true)) + (margin_top + margin_bottom);
    };
    ...
    PassengerSurveyTableRow.prototype.set_attributes_of_station_info = function() {
      var margin_of_station_codes, margin_of_station_text;
      station_info(this).css('height', station_info_height_new(this));
      margin_of_station_codes = (station_info(this).height() - station_codes(this).height()) * 0.5;
      station_codes(this).css('margin-top', margin_of_station_codes).css('margin-bottom', margin_of_station_codes);
      margin_of_station_text = (station_info(this).height() - station_text(this).height()) * 0.5;
      station_text(this).css('margin-top', margin_of_station_text).css('margin-bottom', margin_of_station_text);
    };
...
(function() {
  var RailwayLine, TravelTimeInfoTable, WomenOnlyCar, WomenOnlyCarSectionInfo, WomenOnlyCarSectionInfoCar, WomenOnlyCarSectionInfos;
...
(function() {
  ...
  StationTimetables = (function() {
    var hours, mins, operation_day_domains, process_hours, process_mins, process_operation_day_domains, process_station_train_times, process_top_headers;
  ...
  StationTimetable = (function(_super) {
    var rows_of_each_hour, set_height_of_contents_in_each_hour, set_max_width_to_all_station_train_times, station_train_times;
  ...
  StationTimetableContents = (function() {
    ...
    function StationTimetableContents(domains) {
      ...
      this.padding_new = Math.ceil((this.inner_width_new - this.max_width) * 0.5);
      return;
    }
