module ForRails::PlatformInfosOfMultipleLine
  ...
  def platform_infos_of_yurakucho_and_fukutoshin_line?( station_facility )
    platform_infos_of_multiple_line?( *( ::TokyoMetro::Modules::Common::Dictionary::RailwayLine::StringList.yurakucho_and_fukutoshin_line_same_as ) ) and between_wakoshi_and_kotake_mukaihara?( station_facility )
  end
