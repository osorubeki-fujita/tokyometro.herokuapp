...
class TokyoMetro::StaticDatas::TrainType::InApi::Info
  ...
  # @example
  #   TokyoMetro::StaticDatas.train_types_in_api.each_value { | train_type | puts train_type.same_as }
  #   =>
  ...
  # @example
  #   TokyoMetro::StaticDatas.train_types_in_api.each_value { | train_type | puts train_type.same_as.ljust(48) + " " + train_type.name_ja }
  #   =>
  ...
  # @example
  #   TokyoMetro::StaticDatas.train_types_in_api.each_value { | train_type | puts train_type.same_as.ljust(48) + " " + train_type.name_en }
  #   =>
  ...
  # @example
  #   TokyoMetro::StaticDatas.train_types_in_api.each_value { | train_type | puts train_type.same_as.ljust(48) + " " + train_type.name_ja_display }
  #   =>
  ...
  # @example
  #   TokyoMetro::StaticDatas.train_types_in_api.each_value { | train_type | puts train_type.same_as.ljust(48) + " " + train_type.name_en_display }
  #   =>
  #   odpt.TrainType:TokyoMetro.Local                  (nil)
  #   odpt.TrainType:TokyoMetro.LimitedExpress         (nil)
  #   odpt.TrainType:TokyoMetro.Express                (nil)
  ...
  # @return [String]
  # @example
  #   TokyoMetro::StaticDatas.train_types_in_api.each_value { | train_type | puts train_type.same_as.ljust(48) + " " + train_type.name_ja_normal }
  #   =>
  #   odpt.TrainType:TokyoMetro.Local                  各停
  #   odpt.TrainType:TokyoMetro.LimitedExpress         特急
  #   odpt.TrainType:TokyoMetro.Express                急行
  ...
  # @return [String]
  # @example
  #   TokyoMetro::StaticDatas.train_types_in_api.each_value { | train_type | puts train_type.same_as.ljust(48) + " " + train_type.name_en_normal }
  #   =>
  #   odpt.TrainType:TokyoMetro.Local                  Local
  #   odpt.TrainType:TokyoMetro.LimitedExpress         Limited Express
  #   odpt.TrainType:TokyoMetro.Express                Express
  ...
  def self.generate_from_hash( same_as , h )
    ary_of_keys = [ :name_ja , :name_ja_display , :name_en , :name_en_display ]
    infos = ary_of_keys.map { | key | generate_from_hash__set_variable( h , key ) }

    self.new( same_as , *infos )
  end

  def seed
    ::TrainTypeInApi.create(
      same_as: @same_as ,
      name_ja: @name_ja ,
      name_en: @name_en ,
      name_ja_display: @name_ja_display ,
