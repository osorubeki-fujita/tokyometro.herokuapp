...
module TokyoMetro::ApiModules::ToFactoryClass::GenerateFromSavedFile::TrainLocation
  ...
  # @!group 保存済みの情報を処理するメソッド
    ...
    # @param line [String] 列車ロケーション情報の路線名
    ...
    def generate_from_saved_file( y , m , d , line: nil , file_type: :json , db_dirname_sub: nil , max: nil )
      factory_for_generating_from_saved_file.process( y , m , d , line , file_type , db_dirname , db_dirname_sub , max )
    end
    ...
    # @note max を nil とした場合は無制限で、すべてのファイルを配列に格納する。
    # @return [TokyoMetro::Api::TrainLocation::List]
    def generate_from_saved_json( y , m , d , line: nil , db_dirname_sub: nil , max: nil )
      generate_from_saved_file( y , m , d ,
        line: line , db_dirname_sub: db_dirname_sub ,
    ...
    # @note max を nil とした場合は無制限で、すべてのファイルを配列に格納する。
    # @return [TokyoMetro::Api::TrainLocation::List]
    def generate_from_saved_yaml( y , m , d , line: nil , db_dirname_sub: nil , max: nil )
      generate_from_saved_file( y , m , d ,
        line: line , db_dirname_sub: db_dirname_sub ,
