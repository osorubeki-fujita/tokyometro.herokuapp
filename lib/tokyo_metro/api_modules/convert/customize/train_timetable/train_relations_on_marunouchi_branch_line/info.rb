# @note {TokyoMetro::ApiModules::Convert::Customize::TrainTimetable::TrainRelationsOnMarunouchiBranchLine#.set_modules} により {::TokyoMetro::Api::TrainTimetable::Info} へ prepend される。
module TokyoMetro::ApiModules::Convert::Customize::TrainTimetable::TrainRelationsOnMarunouchiBranchLine::Info
  ...
  def self.marunouchi_branch_line_dictionary_namespace
    ::TokyoMetro::ApiModules::Convert::Customize::TrainTimetable::TrainRelationsOnMarunouchiBranchLine::Dictionary
  end
