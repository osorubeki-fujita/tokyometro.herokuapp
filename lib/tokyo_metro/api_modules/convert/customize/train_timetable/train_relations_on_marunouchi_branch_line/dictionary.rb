# @note {TokyoMetro::ApiModules::Convert::Customize::TrainTimetable::TrainRelationsOnMarunouchiBranchLine#.set_modules} により {::TokyoMetro::Api::TrainTimetable::Info} へ include される。
module TokyoMetro::ApiModules::Convert::Customize::TrainTimetable::TrainRelationsOnMarunouchiBranchLine::Dictionary
