...
module TokyoMetro::ApiModules::Convert::Customize::StationFacility::RailwayLineNameInPlatformTransferInfo::Info
  ...
  #     in {TokyoMetro::ApiModules::Convert::Common::StationInfos::ConvertRailwayLineNames::Info} .
  # @note
  ...
  def convert_railway_line_names_in_platform_transfer_infos
    replacing = ::TokyoMetro::ApiModules::Convert::Customize::StationFacility::RailwayLineNameInPlatformTransferInfo.replacing_railway_lines
    ignored = nil
  ...
  #     by {TokyoMetro::ApiModules::Convert::Common::StationInfos::ConvertRailwayLineNames::Info#replace_railway_line_info} .
