module TokyoMetro::ApiModules::Convert::Customize::StationTimetable::ChiyodaBranchLine::Info
  ...
  def convert_infos_related_to_chiyoda_branch_line
    ...
    if same_as?( regexp )
      ...
      class << @fundamental_infos
        include ::TokyoMetro::ApiRefinements::StationTimetable::Info::Fundamental::List
      end
