module TokyoMetro::ApiModules::Convert::Customize::RailwayLine::ChiyodaBranchLine::Generate::List
  ...
  def generate( max = nil )
    ...
    regexp_for_replace = ::TokyoMetro::ApiModules::Convert::Customize::Dictionary::RegexpForReplace.chiyoda_branch_line_stations
