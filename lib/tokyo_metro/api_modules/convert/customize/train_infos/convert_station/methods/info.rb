module TokyoMetro::ApiModules::Convert::Customize::TrainInfos::ConvertStation::Methods::Info
  ...
  def customized_station_name( name_in_api , title = nil )
    ::TokyoMetro::CommonModules::Dictionary::Station.station_same_as_in_db( name_in_api , title )
  end
