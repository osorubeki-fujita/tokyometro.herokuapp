...
module TokyoMetro::ApiModules::Convert::Customize::Station::ConnectingRailwayLine::Info

  # Constructor
  # @note
  #   This method uses {TokyoMetro::ApiModules::Convert::Common::Station::ConnectingRailwayLine::Info#convert_and_delete_connecting_railway_line_names} .
  # @note
  ...
  def initialize( *variables )
    ...
    convert_and_delete_connecting_railway_line_names(
      replacing: ::TokyoMetro::ApiModules::Convert::Customize::Station::ConnectingRailwayLine.replacing_railway_lines ,
      ignored: ::TokyoMetro::ApiModules::Convert::Customize::Station::ConnectingRailwayLine.ignored_railway_lines
    )
  ...
  def add_optional_railway_lines
    optional_railway_lines = ::TokyoMetro::ApiModules::Convert::Customize::Station::ConnectingRailwayLine.optional_railway_lines.select { | item |
  ...
  def add_new_railway_lines
    new_railway_lines = ::TokyoMetro::ApiModules::Convert::Customize::Station::ConnectingRailwayLine.new_railway_lines.select { | new_railway_line_name , info |
  ...
  def set_index_in_station
    index_info_in_this_station = ::TokyoMetro::ApiModules::Convert::Customize::Station::ConnectingRailwayLine.index_in_stations[ @same_as ]
  ...
  def transfer_additional_infos_of_this_station
    ary = ::TokyoMetro::ApiModules::Convert::Customize::Station::ConnectingRailwayLine.transfer_additional_infos.select { | item |
      item[ "stations" ].include?( @same_as )
    }
    if ary.present?
      h = ::Hash.new
