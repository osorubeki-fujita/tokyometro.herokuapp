...
class TokyoMetro::Factories::Get::Api::DataSearch::StationFacility < TokyoMetro::Factories::Get::Api::MetaClass::DataSearch
  ...
  def parameters
    ...
    # puts "-" * 96
    # puts "(11) TokyoMetro::Factories::Get::Api::DataSearch::StationFacility\##{__method__}"

    set_parameter_send_to_api( h , "\@id" , @id , String )
    set_parameter_send_to_api( h , "owl:sameAs" , @same_as , String )
    # puts "(12) TokyoMetro::Factories::Get::Api::DataSearch::StationFacility\##{__method__}"
