...
class TokyoMetro::Factories::Seed::Api::StationTrainTime
  ...
  def self.check_number( *symbol_of_railway_lines )
    ::TokyoMetro::Factories::Seed::Api::StationTrainTime::Checker.check_number( *symbol_of_railway_lines )
  end

  def self.destroy!( *symbol_of_railway_lines )
    ::TokyoMetro::Factories::Seed::Api::StationTrainTime::Checker.destroy!( *symbol_of_railway_lines )
  end

  def self.display_railway_line_info_in_db( *symbol_of_railway_lines )
    ::TokyoMetro::Factories::Seed::Api::StationTrainTime::Checker.display_railway_line_info_in_db( *symbol_of_railway_lines )
  end

  def self.check_chiyoda_line_info_in_db
    ::TokyoMetro::Factories::Seed::Api::StationTrainTime::Checker.display_railway_line_info_in_db( :chiyoda )
  end
