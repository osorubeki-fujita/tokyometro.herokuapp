class TokyoMetro::Factories::Seed::Api::StationTimetable::Info::TrainTime::Info < TokyoMetro::Factories::Seed::Api::MetaClass::Info
  ...
  def self.train_timetable_update_processor_class
    ::TokyoMetro::Factories::Seed::Api::StationTimetable::Info::TrainTime::Info::UpdateTrainTimetable
  end
