class TokyoMetro::Factories::Seed::Api::StationTimetable::Info::TrainTime::Info::TrainType < TokyoMetro::Factories::Seed::Api::MetaClass::Timetables::TrainType

  @patterns = ::Array.new

  include ::TokyoMetro::Modules::Common::Info::Decision::CompareBase

  include ::TokyoMetro::Factories::Seed::Api::MetaClass::Timetables::TrainTypeModules::CurrentStation
  include ::TokyoMetro::Factories::Seed::Api::MetaClass::Timetables::TrainTypeModules::ConvertRailwayLine

  def initialize( train_type , railway_line_in_db , terminal_station_in_db , operation_day_in_db , stations_in_db )
  ...
  def self.train_type_pattern_class
    ::TokyoMetro::Factories::Seed::Api::StationTimetable::Info::TrainTime::Info::TrainType::Pattern
  end
