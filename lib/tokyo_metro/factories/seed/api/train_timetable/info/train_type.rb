class TokyoMetro::Factories::Seed::Api::TrainTimetable::Info::TrainType < TokyoMetro::Factories::Seed::Api::MetaClass::Timetables::TrainType

  @patterns = ::Array.new

  include ::TokyoMetro::Modules::Common::Info::Decision::CompareBase

  include ::TokyoMetro::Factories::Seed::Api::MetaClass::Timetables::TrainTypeModules::StartingStation
  ...
  def self.train_type_pattern_class
    ::TokyoMetro::Factories::Seed::Api::TrainTimetable::Info::TrainType::Pattern
  end
