class TokyoMetro::Factories::Seed::Api::StationTrainTime::TrainInStationTimetable

  # Constructor
  # @param station_timetable_info [::TokyoMetro::Factories::Seed::Api::StationTrainTime::TrainInStationTimetable::StationTimetableInfo]
  ...
  # @return [::TokyoMetro::Factories::Seed::Api::StationTrainTime::TrainInStationTimetable::StationTimetableInfo]
  ...
  # @note {::TokyoMetro::Factories::Seed::Api::StationTrainTime::TrainInStationTimetable::StationTimetableInfo} のメソッド
