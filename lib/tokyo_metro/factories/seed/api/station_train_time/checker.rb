class TokyoMetro::Factories::Seed::Api::StationTrainTime::Checker
...
=begin
    {
      ...
      station_train_times_from_station_timetables: @station_train_times_from_station_timetables ,
      station_train_times_from_train_timetables: @station_train_times_from_train_timetables ,
      number_of_station_train_times_in_api: @number_of_station_train_times_in_api
    }
=end
  end
