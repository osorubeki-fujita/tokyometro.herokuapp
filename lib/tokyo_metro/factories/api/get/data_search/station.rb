...
class TokyoMetro::Factories::Api::Get::DataSearch::Station < TokyoMetro::Factories::Api::Get::MetaClass::DataSearch

  include ::TokyoMetro::ClassNameLibrary::Api::Station

  # Constructor
  def initialize( id , same_as , title , operator , railway_line , station_code ,
  ...
  def parameters
    ...
    set_parameter_send_to_api( h , "odpt:station_code" , @station_code , String )
  ...
  def self.process( http_client , id , same_as , title , operator , railway_line , station_code ,
    perse_json , generate_instance , to_inspect )

    info = self.new( id , same_as , title , operator , railway_line , station_code ,
      perse_json , generate_instance , to_inspect )
