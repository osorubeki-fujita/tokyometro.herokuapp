...
class TokyoMetro::Factories::Api::Get::DataSearch::StationFacility < TokyoMetro::Factories::Api::Get::MetaClass::DataSearch
  ...
  def parameters
    ...
    # puts "-" * 96
    # puts "(11) TokyoMetro::Factories::Api::Get::DataSearch::StationFacility\##{__method__}"

    set_parameter_send_to_api( h , "\@id" , @id , String )
    set_parameter_send_to_api( h , "owl:sameAs" , @same_as , String )
    # puts "(12) TokyoMetro::Factories::Api::Get::DataSearch::StationFacility\##{__method__}"
