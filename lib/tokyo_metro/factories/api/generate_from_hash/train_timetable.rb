...
class TokyoMetro::Factories::Api::GenerateFromHash::TrainTimetable < TokyoMetro::Factories::Api::GenerateFromHash::MetaClass::Fundamental
  ...
  def variables
    ...
    [ id_urn , same_as , date , train_number , railway_line , operator , train_type , railway_direction ,
