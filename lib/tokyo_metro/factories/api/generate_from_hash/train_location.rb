...
class TokyoMetro::Factories::Api::GenerateFromHash::TrainLocation < TokyoMetro::Factories::Api::GenerateFromHash::MetaClass::Fundamental
  ...
  def variables
    ...
    [ id , same_as , train_number , train_type , date , valid , frequency ,
