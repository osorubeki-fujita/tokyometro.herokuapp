...
class TokyoMetro::Factories::Api::GenerateFromHash::StationTimetable::Info::Train < TokyoMetro::Factories::Api::GenerateFromHash::MetaClass::NotOnTheTopLayer
  ...
  def variables
    ...
    # 列車の補足情報のインスタンスを取得
    note = self.class.note_list_class.generate_from_string( @hash[ "odpt:note" ] )
