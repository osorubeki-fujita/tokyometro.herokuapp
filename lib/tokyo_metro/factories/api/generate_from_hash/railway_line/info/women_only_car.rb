...
class TokyoMetro::Factories::Api::GenerateFromHash::RailwayLine::Info::WomenOnlyCar < TokyoMetro::Factories::Api::GenerateFromHash::MetaClass::NotOnTheTopLayer
  ...
  def variables
    ...
    ary += ary_of_keys_2.map { | key |
      ...
      h , m = str.split( /\:/ ).map{ | str | str.to_i }
