...
class TokyoMetro::Factories::Save::Api::MetaClass::Group
  ...
  # @return [::TokyoMetro::Factories::Save::Api::MetaClass::Group::List <FileInfo>]
  def to_data_list
  ...
  # @note 可変長引数 必須の引数
  #   [TokyoMetro::Factories::Save::Api::TrainLocation::Group のみ]
  ...
  def self.list_class_for_saving_grouped_infos
    error_msg = [
      ...
      "Please set an constant indicating sub-class of \'::TokyoMetro::Factories::Save::Api::MetaClass::Group::List\'."
    ].join( "\n" )
    raise error_msg
  end
  ...
  def self.file_info_class_for_saving
    error_msg = [
      "Error: This class method \'#{ __method__ }\' is not defind yet in this class \'#{self.name}\'." ,
      "Please set an constant indicating sub-class of \'::TokyoMetro::Factories::Save::Api::MetaClass::Group::FileInfo\'."
    ].join( "\n" )
    raise error_msg
  end
