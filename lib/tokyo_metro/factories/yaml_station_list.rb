...
class TokyoMetro::Factories::YamlStationList
  ...
  def self.process
    ...
    files = Dir.glob( "#{ ::TokyoMetro::DB_DIR }/dictionary/station/**/**.csv" )
    ...
    files.each do | file |
      ...
      file_generated = file.gsub( "#{ ::TokyoMetro::DB_DIR }/dictionary" , ::TokyoMetro.dictionary_dir ).gsub( /\.csv\Z/ , ".yaml" )
