...
class TokyoMetro::Factories::Generate::Static::MetaClass::Group::MultipleYamls < TokyoMetro::Factories::Generate::Static::MetaClass::Group::Fundamental::FromHash
  ...
  def inspect_title
    ...
    puts " " * 4 + "< TokyoMetro::Factories::Generate::Static::MetaClass::Group::MultipleYamls"
    puts ""
  end
  ...
  # @note ロジックは {TokyoMetro::Factories::Generate::Static::MetaClass::Group::Fundamental::FromHash.from_yamls} とほとんど同じだが、デフォルトのファイルがリスト（配列）であることに注意
