...
# @note
#   単一の YAML ファイルからハッシュを作成するクラスは、このクラス {TokyoMetro::Factories::Generate::Static::MetaClass::Group::Fundamental::FromHash} を継承して作成する。
#   また、複数の YAML ファイルからハッシュを作成するクラスも、このクラス {TokyoMetro::Factories::Generate::Static::MetaClass::Group::Fundamental::FromHash} を継承するクラス {TokyoMetro::Factories::Generate::Static::MetaClass::Group::MultipleYamls} , {TokyoMetro::Factories::Generate::Static::MetaClass::Group::MultipleYamls::EachFile} をさらに継承して作成する。
class TokyoMetro::Factories::Generate::Static::MetaClass::Group::Fundamental
