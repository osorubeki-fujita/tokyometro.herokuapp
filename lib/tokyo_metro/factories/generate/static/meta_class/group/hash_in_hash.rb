...
class TokyoMetro::Factories::Generate::Static::MetaClass::Group::HashInHash < TokyoMetro::Factories::Generate::Static::MetaClass::Group::MultipleYamls
  ...
  # @return [Hash]
  # @note {TokyoMetro::Factories::Generate::Static::MetaClass::Group::MultipleYamls#generating_procedure} とはロジックが異なることに注意
