# 列車の補足情報を扱うクラス
class TokyoMetro::Api::StationTimetable::Info::Train::Info::Note

  # 列車の補足情報のインスタンスを取得するメソッド
  # @param str [String] 列車の補足情報の文字列
  # @return [classes under TokyoMetro::Api::StationTimetable::Info::Train::Info::Note]
  def self.generate_from_string( str )
    ...
    #---- 発着ホーム
      ...
      DepartFrom.set_from_string( $1.zen_num_to_han.to_i )
...
# note/list.rb
# note/starting_station.rb
# note/start_from_this_station.rb
# note/arrive_at.rb
# note/depart_from.rb
# note/connection_info.rb
# note/shirokane_takanawa.rb
# note/yurakucho_fukutoshin.rb