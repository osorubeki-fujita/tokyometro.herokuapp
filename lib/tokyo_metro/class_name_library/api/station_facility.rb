...
module TokyoMetro::ClassNameLibrary::Api::StationFacility
  ...
  module ClassMethods
    ...
    # @return [Const ( ::TokyoMetro::Factories::Get::Api::DataSearch::StationFacility )]
    def factory_for_getting
      ::TokyoMetro::Factories::Get::Api::DataSearch::StationFacility
    end

    # API から取得したデータを保存するための Factory Pattern クラス
    # @return [Const ( ::TokyoMetro::Factories::Save::Api::StationFacility::EachFile )]
    def factory_for_saving_to_each_file
      ::TokyoMetro::Factories::Save::Api::StationFacility::EachFile
    end

    # グループ化されたデータを保存するための Factory Pattern クラス
    # @return [Const ( ::TokyoMetro::Factories::Save::Api::StationFacility::Group )]
    def factory_for_saving_datas_of_each_group
      ::TokyoMetro::Factories::Save::Api::StationFacility::Group
    end

    def list_class_for_saving_grouped_infos
      ::TokyoMetro::Factories::Save::Api::StationFacility::Group::List
    end

    def file_info_class_for_saving
      ::TokyoMetro::Factories::Save::Api::StationFacility::Group::FileInfo
    end

    # JSON をパースして得られた配列の要素である Hash からインスタンスを作成するメソッドための Factory Pattern クラス
    # @return [Const ( ::TokyoMetro::Factories::Generate::Api::StationFacility::Info )]
    def factory_for_generating_from_hash
      ::TokyoMetro::Factories::Generate::Api::StationFacility::Info
    end

    # @note {::TokyoMetro::Factories::Generate::Api::StationFacility::Info::BarrierFree::Info::Info} でないことに注意
    def factory_for_generating_barrier_free_info_from_hash
      ::TokyoMetro::Factories::Generate::Api::StationFacility::Info::BarrierFree::Info
    end

    def factory_for_generating_barrier_free_service_detail_from_hash
      ::TokyoMetro::Factories::Generate::Api::StationFacility::Info::BarrierFree::Info::ServiceDetail::Info
    end

    def factory_for_generating_barrier_free_elevator_info_from_hash
      ::TokyoMetro::Factories::Generate::Api::StationFacility::Info::BarrierFree::Info::Facility::Elevator
    end

    def factory_for_generating_barrier_free_escalator_info_from_hash
      ::TokyoMetro::Factories::Generate::Api::StationFacility::Info::BarrierFree::Info::Facility::Escalator
    end

    def factory_for_generating_barrier_free_escalator_service_detail_from_hash
      ::TokyoMetro::Factories::Generate::Api::StationFacility::Info::BarrierFree::Info::Facility::Escalator::ServiceDetail::Info
    end
    ...
    def factory_for_generating_barrier_free_stairlift_info_from_hash
      ::TokyoMetro::Factories::Generate::Api::StationFacility::Info::BarrierFree::Info::Facility::Stairlift
    end

    def factory_for_generating_barrier_free_toilet_info_from_hash
      ::TokyoMetro::Factories::Generate::Api::StationFacility::Info::BarrierFree::Info::Facility::Toilet
    end

    def factory_for_generating_barrier_free_toilet_assistant_from_hash
      ::TokyoMetro::Factories::Generate::Api::StationFacility::Info::BarrierFree::Info::Facility::Toilet::Assistant
    end

    def factory_for_generating_platform_info_from_hash
      ::TokyoMetro::Factories::Generate::Api::StationFacility::Info::Platform::Info
    end

    def factory_for_generating_platform_barrier_free_info_from_string
      ::TokyoMetro::Factories::Generate::Api::StationFacility::Info::Platform::Info::BarrierFree::Info
    end

    def factory_for_generating_platform_transfer_info_from_hash
      ::TokyoMetro::Factories::Generate::Api::StationFacility::Info::Platform::Info::Transfer::Info
    end

    def factory_for_generating_platform_surrounding_area_info_from_string
      ::TokyoMetro::Factories::Generate::Api::StationFacility::Info::Platform::Info::SurroundingArea::Info
    end

    # 保存済みの情報を処理しインスタンスを復元するための Factory Pattern クラス
    # @return [Const ( ::TokyoMetro::Factories::Generate::Api::StationFacility::List )]
    def factory_for_generating_from_saved_file
      ::TokyoMetro::Factories::Generate::Api::StationFacility::List
    end

    # @!group DB

    def factory_for_seeding_list
      ::TokyoMetro::Factories::Seed::Api::StationFacility::List
    end

    def factory_for_seeding_info
      ::TokyoMetro::Factories::Seed::Api::StationFacility::Info
    end

    def factory_for_seeding_barrier_free_facilities
      ::TokyoMetro::Factories::Seed::Api::StationFacility::List::BarrierFree
    end

    def factory_for_seeding_barrier_free_facilities_of_each_station
      ::TokyoMetro::Factories::Seed::Api::StationFacility::Info::BarrierFree::List
    end

    def factory_for_seeding_barrier_free_facility_info
      ::TokyoMetro::Factories::Seed::Api::StationFacility::Info::BarrierFree::Info
    end

    def factory_for_seeding_barrier_free_facility_escalator_info
      ::TokyoMetro::Factories::Seed::Api::StationFacility::Info::BarrierFree::Facility::Escalator::Info
    end

    def factory_for_seeding_barrier_free_facility_toilet_info
      ::TokyoMetro::Factories::Seed::Api::StationFacility::Info::BarrierFree::Facility::Toilet::Info
    end

    def factory_for_seeding_barrier_free_facility_service_detail_list
      ::TokyoMetro::Factories::Seed::Api::StationFacility::Info::BarrierFree::ServiceDetail::List
    end

    def factory_for_seeding_barrier_free_facility_service_detail_info
      ::TokyoMetro::Factories::Seed::Api::StationFacility::Info::BarrierFree::ServiceDetail::Info
    end

    def factory_for_seeding_escalator_service_detail_info
      ::TokyoMetro::Factories::Seed::Api::StationFacility::Info::BarrierFree::Facility::Escalator::ServiceDetail::Info
    end

    def factory_for_seeding_escalator_service_detail_direction
      ::TokyoMetro::Factories::Seed::Api::StationFacility::Info::BarrierFree::Facility::Escalator::ServiceDetail::Direction
    end

    def factory_for_seeding_toilet_service_detail_assistant_info
      ::TokyoMetro::Factories::Seed::Api::StationFacility::Info::BarrierFree::Facility::Toilet::Assistant
    end

    def factory_for_seeding_platform_infos
      ::TokyoMetro::Factories::Seed::Api::StationFacility::List::Platform
    end

    def factory_for_seeding_platform_infos_of_each_station
      ::TokyoMetro::Factories::Seed::Api::StationFacility::Info::Platform::List
    end

    def factory_for_seeding_platform_info
      ::TokyoMetro::Factories::Seed::Api::StationFacility::Info::Platform::Info
    end

    def factory_for_seeding_platform_info_transfer_list
      ::TokyoMetro::Factories::Seed::Api::StationFacility::Info::Platform::Info::Transfer::List
    end

    def factory_for_seeding_platform_info_transfer_info
      ::TokyoMetro::Factories::Seed::Api::StationFacility::Info::Platform::Info::Transfer::Info
    end

    def factory_for_seeding_platform_info_barrier_free_list
      ::TokyoMetro::Factories::Seed::Api::StationFacility::Info::Platform::Info::BarrierFree::List
    end

    def factory_for_seeding_platform_info_barrier_free_info
      ::TokyoMetro::Factories::Seed::Api::StationFacility::Info::Platform::Info::BarrierFree::Info
    end

    def factory_for_seeding_platform_info_surrounding_area_list
      ::TokyoMetro::Factories::Seed::Api::StationFacility::Info::Platform::Info::SurroundingArea::List
    end

    def factory_for_seeding_platform_info_surrounding_area_info
      ::TokyoMetro::Factories::Seed::Api::StationFacility::Info::Platform::Info::SurroundingArea::Info
    end
