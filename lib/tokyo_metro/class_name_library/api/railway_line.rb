...
module TokyoMetro::ClassNameLibrary::Api::RailwayLine
  ...
  # @!group クラスメソッド (1) - メタデータ
    ...
    # @return [Const ( ::TokyoMetro::Factories::Get::Api::DataSearch::RailwayLine )]
    def factory_for_getting
      ::TokyoMetro::Factories::Get::Api::DataSearch::RailwayLine
    end

    # API からデータを取得するための Factory Pattern クラス（地物検索 API）
    # @return [Const ( ::TokyoMetro::Factories::Get::Api::Geo::RailwayLine )]
    def factory_for_getting_geo
      ::TokyoMetro::Factories::Get::Api::Geo::RailwayLine
    end

    # API から取得したデータを保存するための Factory Pattern クラス
    # @return [Const ( ::TokyoMetro::Factories::Save::Api::RailwayLine::EachFile )]
    def factory_for_saving_to_each_file
      ::TokyoMetro::Factories::Save::Api::RailwayLine::EachFile
    end

    # グループ化されたデータを保存するための Factory Pattern クラス
    # @return [Const ( ::TokyoMetro::Factories::Save::Api::RailwayLine::Group )]
    def factory_for_saving_datas_of_each_group
      ::TokyoMetro::Factories::Save::Api::RailwayLine::Group
    end

    def list_class_for_saving_grouped_infos
      ::TokyoMetro::Factories::Save::Api::RailwayLine::Group::List
    end

    def file_info_class_for_saving
      ::TokyoMetro::Factories::Save::Api::RailwayLine::Group::FileInfo
    end

    # JSON をパースして得られた配列の要素である Hash からインスタンスを作成するメソッドための Factory Pattern クラス
    # @return [Const ( ::TokyoMetro::Factories::Generate::Api::RailwayLine::Info )]
    def factory_for_generating_from_hash
      ::TokyoMetro::Factories::Generate::Api::RailwayLine::Info
    end

    def factory_for_generating_station_order_info_from_hash
      ::TokyoMetro::Factories::Generate::Api::RailwayLine::Info::StationOrder::Info
    end

    def factory_for_generating_travel_time_info_from_hash
      ::TokyoMetro::Factories::Generate::Api::RailwayLine::Info::TravelTime::Info
    end

    def factory_for_generating_women_only_car_info_from_hash
      ::TokyoMetro::Factories::Generate::Api::RailwayLine::Info::WomenOnlyCar::Info
    end

    # 保存済みの情報を処理しインスタンスを復元するための Factory Pattern クラス
    # @return [Const ( ::TokyoMetro::Factories::Generate::Api::RailwayLine::List )]
    def factory_for_generating_from_saved_file
      ::TokyoMetro::Factories::Generate::Api::RailwayLine::List
    end

    # @!group DB に関連するクラスの情報

    # def factory_for_seeding_list_of_station_order_infos
      # ::TokyoMetro::Factories::Seed::Api::RailwayLine::List::StationOrder
    # end

    # def factory_for_seeding_station_order_in_each_railway_line
      # ::TokyoMetro::Factories::Seed::Api::RailwayLine::Info::StationOrder::List
    # end

    # def factory_for_seeding_station_order_infos
      # ::TokyoMetro::Factories::Seed::Api::RailwayLine::Info::StationOrder::Info
    # end

    def factory_for_seeding_list_of_travel_time_infos
      ::TokyoMetro::Factories::Seed::Api::RailwayLine::List::TravelTime
    end

    def factory_for_seeding_travel_time_infos_in_each_railway_line
      ::TokyoMetro::Factories::Seed::Api::RailwayLine::Info::TravelTime::List
    end

    def factory_for_seeding_travel_time_infos
      ::TokyoMetro::Factories::Seed::Api::RailwayLine::Info::TravelTime::Info
    end

    def factory_for_seeding_list_of_women_only_car_infos
      ::TokyoMetro::Factories::Seed::Api::RailwayLine::List::WomenOnlyCar
    end

    def factory_for_seeding_women_only_car_infos_in_each_railway_line
      ::TokyoMetro::Factories::Seed::Api::RailwayLine::Info::WomenOnlyCar::List
    end

    def factory_for_seeding_women_only_car_infos
      ::TokyoMetro::Factories::Seed::Api::RailwayLine::Info::WomenOnlyCar::Info
    end
