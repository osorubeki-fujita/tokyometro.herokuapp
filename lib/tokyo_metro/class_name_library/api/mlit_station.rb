...
module TokyoMetro::ClassNameLibrary::Api::MlitStation
  ...
  module ClassMethods
    ...
    # @return [Const ( ::TokyoMetro::Factories::Get::Api::Geo::MlitStation )]
    def factory_for_getting_geo
      ::TokyoMetro::Factories::Get::Api::Geo::MlitStation
    end

    # API から取得したデータを保存するための Factory Pattern クラス
    # @return [Const ( ::TokyoMetro::Factories::Save::Api::MlitStation::EachFile )]
    def factory_for_saving_to_each_file
      ::TokyoMetro::Factories::Save::Api::MlitStation::EachFile
    end

    # グループ化されたデータを保存するための Factory Pattern クラス
    # @return [Const ( ::TokyoMetro::Factories::Save::Api::MlitStation::Group )]
    def factory_for_saving_datas_of_each_group
      ::TokyoMetro::Factories::Save::Api::MlitStation::Group
    end

    def list_class_for_saving_grouped_infos
      ::TokyoMetro::Factories::Save::Api::MlitStation::Group::List
    end

    def file_info_class_for_saving
      ::TokyoMetro::Factories::Save::Api::MlitStation::Group::FileInfo
    end

    # JSON をパースして得られた配列の要素である Hash からインスタンスを作成するメソッドための Factory Pattern クラス
    # @return [Const ( ::TokyoMetro::Factories::Generate::Api::MlitStation::Info )]
    def factory_for_generating_from_hash
      ::TokyoMetro::Factories::Generate::Api::MlitStation::Info
    end

    # 保存済みの情報を処理しインスタンスを復元するための Factory Pattern クラス
    # @return [Const ( ::TokyoMetro::Factories::Generate::Api::MlitStation::List )]
    def factory_for_generating_from_saved_file
      ::TokyoMetro::Factories::Generate::Api::MlitStation::List
    end
