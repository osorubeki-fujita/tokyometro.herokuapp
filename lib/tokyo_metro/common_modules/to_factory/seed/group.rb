...
# @note {TokyoMetro::CommonModules::ToFactory::Seed::Hash} , {TokyoMetro::CommonModules::ToFactory::Seed::List} で使用
module TokyoMetro::CommonModules::ToFactory::Seed::Group
