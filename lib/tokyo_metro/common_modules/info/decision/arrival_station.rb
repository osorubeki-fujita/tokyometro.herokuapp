module TokyoMetro::CommonModules::Info::Decision::ArrivalStation

  # @!group 到着駅に関するメソッド

  def arrival_at_yoyogi_uehara?
    arrival_at?( ::TokyoMetro::CommonModules::Dictionary::Station::StringInfo.yoyogi_uehara )
  end

  def arrival_at_wakoshi?
    arrival_at?( ::TokyoMetro::CommonModules::Dictionary::Station::StringList.wakoshi )
  end

  def arrival_at_wakoshi_on_yurakucho_line?
    arrival_at?( ::TokyoMetro::CommonModules::Dictionary::Station::StringInfo.wakoshi_on_yurakucho_line )
  end

  def arrival_at_wakoshi_on_fukutoshin_line?
    arrival_at?( ::TokyoMetro::CommonModules::Dictionary::Station::StringInfo.wakoshi_on_fukutoshin_line )
  end
