module TokyoMetro::CommonModules::Info::Decision::TerminalStation
  ...
  # @note ::TokyoMetro::CommonModules::Dictionary::Station::StringInfo を用いて定義
  ...
  ::TokyoMetro::CommonModules::Dictionary::Station::StringInfo.constants( false ).each do | const_name |
    eval <<-DEF
      def terminating_at_#{ const_name.downcase }?
        bound_for?( ::TokyoMetro::CommonModules::Dictionary::Station::StringInfo.#{ const_name.downcase } )
      end
    DEF
  ...
  #---------------- is_terminating_at_xxx?
  # @note ::TokyoMetro::CommonModules::Dictionary::Station::RegexpInfo を用いて定義

  ::TokyoMetro::CommonModules::Dictionary::Station::RegexpInfo.constants( false ).each do | const_name |
    eval <<-DEF
      def terminating_at_#{ const_name.downcase }?
        bound_for?( ::TokyoMetro::CommonModules::Dictionary::Station::RegexpInfo.#{ const_name.downcase } )
      end
    DEF
  ...
  #---------------- is_terminating_at_xxx?
  # @note ::TokyoMetro::CommonModules::Dictionary::RailwayLine::RegexpInfo を用いて定義
  ...
  ::TokyoMetro::CommonModules::Dictionary::RailwayLine::RegexpInfo.constants( false ).each do | const_name |
    eval <<-DEF
      def terminating_on_#{ const_name.downcase }?
        bound_for?( ::TokyoMetro::CommonModules::Dictionary::RailwayLine::RegexpInfo.#{ const_name.downcase } )
      end
    DEF
  ...
  def terminating_on_marunouchi_branch_line_including_invalid?
    bound_for?( ::TokyoMetro::CommonModules::Dictionary::Station::StringList.between_honancho_and_nakano_sakaue_including_invalid )
  end
