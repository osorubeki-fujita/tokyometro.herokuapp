module TokyoMetro::CommonModules::Info::Decision::RailwayLine
  ...
  ::YAML.load_file( "#{ ::TokyoMetro::dictionary_dir }/railway_line/tokyo_metro_lines_in_system.yaml" ).each do | item |
    ...
    eval <<-DEF
      def on_#{ railway_line_base_name }_line?
        on_the_railway_line_of?( ::TokyoMetro::CommonModules::Dictionary::RailwayLine::StringInfo.#{railway_line_base_name} )
      end
  ...
  def on_marunouchi_line_including_branch?
    on_the_railway_line_of?( *( ::TokyoMetro::CommonModules::Dictionary::RailwayLine::StringList.marunouchi_main_and_branch_line_same_as ) )
  end

  def on_yurakucho_or_fukutoshin_line?
    on_the_railway_line_of?( *( ::TokyoMetro::CommonModules::Dictionary::RailwayLine::StringList.yurakucho_and_fukutoshin_line_same_as ) )
  end
