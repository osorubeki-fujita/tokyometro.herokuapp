module TokyoMetro::CommonModules::Info::Decision::StartingStation
  ...
  ::TokyoMetro::CommonModules::Dictionary::Station::StringInfo.constants( false ).each do | const_name |
    eval <<-DEF
      def starting_at_#{ const_name.downcase }?
        starting?( ::TokyoMetro::CommonModules::Dictionary::Station::StringInfo.#{ const_name.downcase } )
      end
    DEF
  ...
  ::TokyoMetro::CommonModules::Dictionary::Station::RegexpInfo.constants( false ).each do | const_name |
    eval <<-DEF
      def starting_at_#{ const_name.downcase }?
        starting?( ::TokyoMetro::CommonModules::Dictionary::Station::RegexpInfo.#{ const_name.downcase } )
      end
    DEF
  ...
  ::TokyoMetro::CommonModules::Dictionary::RailwayLine::RegexpInfo.constants( false ).each do | const_name |
    eval <<-DEF
      def starting_on_#{ const_name.downcase }?
        starting?( ::TokyoMetro::CommonModules::Dictionary::RailwayLine::RegexpInfo.#{ const_name.downcase } )
      end
    DEF
  ...
  def starting_on_marunouchi_branch_line_including_invalid?
    starting?( ::TokyoMetro::CommonModules::Dictionary::Station::StringList.between_honancho_and_nakano_sakaue_including_invalid )
  end
