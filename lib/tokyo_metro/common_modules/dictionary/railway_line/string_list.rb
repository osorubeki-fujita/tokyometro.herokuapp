...
module TokyoMetro::CommonModules::Dictionary::RailwayLine::StringList
  ...
  # @example
  #   TokyoMetro::CommonModules::Dictionary::RailwayLine::StringList.marunouchi_main_and_branch_line_same_as => [
  ...
  # @example
  #   TokyoMetro::CommonModules::Dictionary::RailwayLine::StringList.chiyoda_main_and_branch_line_in_system => [
  #     "Chiyoda",
  #     "ChiyodaBranch"
  #   ]
  ...
  # @example
  #   TokyoMetro::CommonModules::Dictionary::RailwayLine::StringList.chiyoda_main_and_branch_line_same_as => [
  ...
  # @example
  #   TokyoMetro::CommonModules::Dictionary::RailwayLine::StringList.yurakucho_and_fukutoshin_line_same_as => [
  ...
  # @example
  #   TokyoMetro::CommonModules::Dictionary::RailwayLine::StringList.namboku_and_toei_mita_line_same_as => [
