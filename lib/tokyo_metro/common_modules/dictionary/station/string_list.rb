module TokyoMetro::CommonModules::Dictionary::Station::StringList
  ...
  class << self
    ...
    def stations_same_as_in_railway_lines( railway_lines_in_system , station_names )
  ...
  # @return [::Array <String>]
  BETWEEN_HONANCHO_AND_NAKANO_SHIMBASHI = stations_same_as_in_marunouchi_main_and_branch_lines(
  ...
  # @return [::Array <String>]
  BETWEEN_HONANCHO_AND_NAKANO_SAKAUE = stations_same_as_in_marunouchi_main_and_branch_lines(
  ...
  # @return [::Array <String>]
  NAMBOKU_AND_TOEI_MITA_COMMON_STATIONS_IN_SYSTEM = %W( Meguro Shirokanedai ShirokaneTakanawa )

  # 南北線・都営三田線 共用区間の駅（目黒、白金台、白金高輪）
  # @return [::Array <String>]
  NAMBOKU_AND_TOEI_MITA_COMMON_STATIONS = stations_same_as_in_namboku_and_toei_mita_lines(
    NAMBOKU_AND_TOEI_MITA_COMMON_STATIONS_IN_SYSTEM
  )
