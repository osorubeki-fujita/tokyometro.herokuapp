...
# @note TokyoMetro::StaticDatas::Operator::Hash などに include する。
module TokyoMetro::StaticDataModules::Hash::MakeScss
...
# @!group SCSS ファイルの作成
  ...
  def self.scss_color_factory
    ::TokyoMetro::Factories::Scss::Color
  end

  # SCCS の color ファイルを作成する Factory Pattern Class のインスタンスを返すメソッド
  # @return [subclass of TokyoMetro::Factories::Scss::Color]
  ...
  # @note TokyoMetro::Factories::Scss::Color（のサブクラス）のインスタンスが生成される。
  # @return [nil]
