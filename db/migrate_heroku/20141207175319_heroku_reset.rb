class HerokuReset < ActiveRecord::Migration
  ...
  create_table "connecting_railway_notes", force: true do |t|
    t.text     "note"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "connecting_railways", force: true do |t|
    ...
    t.integer  "connecting_railway_note_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "train_timetable_station_times", force: true do |t|
    t.integer  "train_timetable_id"
    t.integer  "operation_day_id"
    t.integer  "departure_time_hour"
    t.integer  "departure_time_min"
    t.integer  "depatrure_station_id"
    t.integer  "arrival_time_hour"
    t.integer  "arrival_time_min"
