...
%div{ id: :travel_time }
  ...
  - when 1
    ...
    - when "odpt.Railway:TokyoMetro.Chiyoda"
      ...
      - through_operation_a_info = ::TravelTimeInfoDecorator.proc_for_rendering_through_operation_info_of_chiyoda_line_and_odakyu_line
      - through_operation_b = travel_time_info_through_operation_c_joban
      - through_operation_b_info = ::TravelTimeInfoDecorator.proc_for_rendering_through_operation_info_of_chiyoda_line_and_jr_joban_line
      - #
    ...
    = render( "travel_time_info_one_railway_line" , h )
    - #
  - when 2
    - special_proc_of_station = nil
    - special_proc_of_section = nil
