...
class RailwayLineMatrixSmallInfo
  ...
  height = ( v , _railway_line_code_outer = railway_line_code_outer(v) ) ->
    return Math.max( _railway_line_code_outer.outerHeight( true ) , text(v).outerHeight( true ) )

  margin_of_railway_line_code_outer = ( v , _railway_line_code_outer = railway_line_code_outer(v) ) ->
    return ( height( v , _railway_line_code_outer ) - _railway_line_code_outer.outerHeight() ) * 0.5

  margin_of_text = ( v , _railway_line_code_outer = railway_line_code_outer(v) ) ->
  ...
  set_height_and_vertical_align_center: ->
    _railway_line_code_outer = railway_line_code_outer(@)
    _margin_of_railway_line_code_outer = margin_of_railway_line_code_outer( @ , _railway_line_code_outer )
    _margin_of_text = margin_of_text( @ , _railway_line_code_outer )
    ...
    text(@).css( 'margin-top' , _margin_of_text ).css( 'margin-bottom' , _margin_of_text )
    @domain.css( 'height' , height( @ , _railway_line_code_outer ) )
    return
