class Station::Facility::Info < ActiveRecord::Base
  ...
  has_many :railway_lines , through: :connecting_railway_line_infos , class: ::RailwayLine
  # has_many :railway_lines , through: :station_infos <- In this case, railway lines of another operators will not be selected.
