class StoppingPattern < ActiveRecord::Base
  ...
  has_many :train_type_stopping_patterns , class: ::Train::Type::StoppingPattern , foreign_key: :stopping_pattern_id
  has_many :train_type_infos , through: :train_type_stopping_patterns , class: ::Train::Type::Info
end
