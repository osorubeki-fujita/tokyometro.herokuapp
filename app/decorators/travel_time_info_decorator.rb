...
= "(" + necessary_time.to_s + ")"
  ...
  def self.render_travel_time_info_through_operation_info( train_type: nil , from: nil , direction: nil , via: nil , railway_line_and_terminal_station: nil , info: nil )
    raise "Error" if railway_line_and_terminal_station.nil?
    ...
    h_locals = {
      ...
      direction: direction ,
      via: via ,
      railway_line_and_terminal_station: railway_line_and_terminal_station ,
      info: info
    }
    h.render inline: <<-HAML , type: :haml , locals: h_locals
...
%tr{ class: [ :through_operation_info_row , :bottom ] }<
  ...
  %td{ colspan: 3 , class: :through_operation_infos }<
    :ruby
      h = {
        direction: [
          ::Station.find_by_same_as( "odpt.Railway:Tobu.SkyTree.Koshigaya" ) ,
          ::Station.find_by_same_as( "odpt.Railway:Tobu.SkyTree.Kasukabe" ) ,
          ::Station.find_by_same_as( "odpt.Railway:Tobu.SkyTree.TobuDobutsuKoen" )
        ] ,
        ...
        railway_line_and_terminal_station: {
          ...
          terminal_station: ::Station.find_by_same_as( "odpt.Station:Tobu.Nikko.MinamiKurihashi" )
        }
      }
    ...
    :ruby
      h = {
        ...
        railway_line_and_terminal_station: {
          ...
          terminal_station: ::Station.find_by_same_as( "odpt.Station:JR-East.ChuoTozai.Mitaka" )
        }
      }
    = ::TravelTimeInfoDecorator.render_travel_time_info_through_operation_info(h)
      HAML
    ...
    :ruby
      h = {
        railway_line_and_terminal_station: {
          ...
          terminal_station: ::Station.find_by_same_as( "odpt.Station:ToyoRapidRailway.ToyoRapidRailway.ToyoKatsutadai" )
        }
      }
    = ::TravelTimeInfoDecorator.render_travel_time_info_through_operation_info(h)
  ...
  %td{ class: :through_operation_infos }<
    :ruby
      h = {
        railway_line_and_terminal_station: {
          railway_line: ::RailwayLine.find_by_same_as( "odpt.Railway:JR-East.ChuoSobu" ) ,
          terminal_station: ::Station.find_by_same_as( "odpt.Station:JR-East.SobuTozai.Tsudanuma" )
        } ,
        note: "直通運転は朝夕のみ"
      }
    = ::TravelTimeInfoDecorator.render_travel_time_info_through_operation_info(h)
    ...
    %div{ class: :through_operation_info_box }
      :ruby
        h = {
          ...
          direction: [
            ::Station.find_by_same_as( "odpt.Station:Odakyu.Odawara.SeijoGakuenMae" ) ,
            ::Station.find_by_same_as( "odpt.Station:Odakyu.Odawara.Noborito" ) ,
            ::Station.find_by_same_as( "odpt.Station:Odakyu.Odawara.ShinYurigaoka" )
          ] ,
          railway_line_and_terminal_station: {
            railway_line: ::RailwayLine.find_by_same_as( "odpt.Railway:Odakyu.Tama" ) ,
            terminal_station: ::Station.find_by_same_as( "odpt.Station:Odakyu.Tama.Karakida" )
          }
        }
      = ::TravelTimeInfoDecorator.render_travel_time_info_through_operation_info(h)
      ...
      :ruby
        h = {
          ...
          direction: [
            ...
            ::Station.find_by_same_as( "odpt.Station:Odakyu.Odawara.Noborito" ) ,
            ::Station.find_by_same_as( "odpt.Station:Odakyu.Odawara.ShinYurigaoka" ) ,
            ::Station.find_by_same_as( "odpt.Station:Odakyu.Odawara.Machida" ) ,
            ::Station.find_by_same_as( "odpt.Station:Odakyu.Odawara.Ebina" )
          ] ,
          railway_line_and_terminal_station: {
            railway_line: ::RailwayLine.find_by_same_as( "odpt.Railway:Odakyu.Odawara" ) ,
            terminal_station: ::Station.find_by_same_as( "odpt.Station:Odakyu.Odawara.HonAtsugi" )
          }
        }
      = ::TravelTimeInfoDecorator.render_travel_time_info_through_operation_info(h)
      ...
      :ruby
        h = {
          ...
          railway_line_and_terminal_station: [{
            ...
            terminal_station: ::Station.find_by_same_as( "odpt.Station:HakoneTozan.Rail.HakoneYumoto" )
          }]
        }
      = ::TravelTimeInfoDecorator.render_travel_time_info_through_operation_info(h)
      HAML
  ...
  %td{ colspan: 3 , class: :through_operation_infos }<
    :ruby
      h = {
        ...
        direction: [ 
          ::Station.find_by_same_as( "odpt.Station:JR-East.Joban.Matsudo" ) ,
          ::Station.find_by_same_as( "odpt.Station:JR-East.Joban.Kashiwa" ) ,
          ::Station.find_by_same_as( "odpt.Station:JR-East.Joban.Abiko" ) ,
          ::Station.find_by_same_as( "odpt.Station:JR-East.Joban.Toride" )
        ] ,
        railway_line_and_terminal_station: {
          railway_line: ::RailwayLine.find_by_same_as( "odpt.Railway:JR-East.Joban" ) ,
          terminal_station: ::Station.find_by_same_as( "odpt.Station:JR-East.Joban.Toride" )
        } ,
...
%tr{ class: [ :through_operation_info_row , :top ] }<
  ...
  %td{ colspan: 3 , class: :through_operation_infos }<
    :ruby
      h = {
        direction: [
          ::Station.find_by_same_as( "odpt.Station:Tokyu.DenEnToshi.FutakoTamagawa" ) ,
          ::Station.find_by_same_as( "odpt.Station:Tokyu.DenEnToshi.Nagatsuta" )
        ] ,
        railway_line_and_terminal_station: {
          railway_line: ::RailwayLine.find_by_same_as( "odpt.Railway:Tokyu.DenEnToshi" ) ,
          terminal_station: ::Station.find_by_same_as( "odpt.Station:Tokyu.DenEnToshi.ChuoRinkan" )
        }
      }
    = ::TravelTimeInfoDecorator.render_travel_time_info_through_operation_info(h)
      HAML
...
%tr{ class: [ :through_operation_info_row , :bottom ] }<
  ...
  %td{ colspan: 3 , class: :through_operation_infos }<
    :ruby
      h = {
        direction: [
          ::Station.find_by_same_as( "odpt.Station:Tobu.SkyTree.KitaSenju" ) ,
          ::Station.find_by_same_as( "odpt.Station:Tobu.SkyTree.Koshigaya" ) ,
          ::Station.find_by_same_as( "odpt.Station:Tobu.SkyTree.Kasukabe" ) ,
          ::Station.find_by_same_as( "odpt.Station:Tobu.SkyTree.TobuDobutsuKoen" )
        ] ,
        via: ::RailwayLine.find_by_same_as( "odpt.Railway:Tobu.SkyTree" ) ,
        railway_line_and_terminal_station: [{
          railway_line: ::RailwayLine.find_by_same_as( "odpt.Railway:Tobu.Isesaki" ) ,
          terminal_station: ::Station.find_by_same_as( "odpt.Station:Tobu.Isesaki.Kuki" )
        },{
          railway_line: ::RailwayLine.find_by_same_as( "odpt.Railway:Tobu.Nikko" ) ,
          terminal_station: ::Station.find_by_same_as( "odpt.Station:Tobu.Nikko.MinamiKurihashi" )
        }]
...
%tr{ class: [ :through_operation_info_row , :top ] }<
  ...
  %td{ colspan: 3 , class: :through_operation_infos }<
    :ruby
      h = {
        direction: [
          ::Station.find_by_same_as( "odpt.Station:Tokyu.Meguro.Oookayama" ) ,
          ::Station.find_by_same_as( "odpt.Station:Tokyu.Meguro.MusashiKosugi" )
        ] ,
        railway_line_and_terminal_station: {
          railway_line: ::RailwayLine.find_by_same_as( "odpt.Railway:Tokyu.Meguro" ) ,
          terminal_station: ::Station.find_by_same_as( "odpt.Station:Tokyu.Meguro.Hiyoshi" )
        }
      }
    = ::TravelTimeInfoDecorator.render_travel_time_info_through_operation_info(h)
      HAML
    ...
    :ruby
      h = {
        ...
        railway_line_and_terminal_station: {
          ...
          terminal_station: ::Station.find_by_same_as( "odpt.Station:SaitamaRailway.SaitamaRailway.UrawaMisono" )
        }
      }
    = ::TravelTimeInfoDecorator.render_travel_time_info_through_operation_info(h)
      HAML
...
%tr{ class: [ :through_operation_info_row , :bottom ] }<
  ...
  %td{ colspan: 3 , class: :through_operation_infos }<
    :ruby
      h = {
        direction: [
          ::Station.find_by_same_as( "odpt.Station:Tokyu.Toyoko.NakaMeguro" ) ,
          ::Station.find_by_same_as( "odpt.Station:Tokyu.Toyoko.MusashiKosugi" ) ,
          ::Station.find_by_same_as( "odpt.Station:Tokyu.Toyoko.Kikuna" ) ,
          ::Station.find_by_same_as( "odpt.Station:Tokyu.Toyoko.Yokohama" )
        ] ,
        ...
        railway_line_and_terminal_station: {
          ...
          terminal_station: ::Station.find_by_same_as( "odpt.Station:YokohamaMinatomiraiRailway.Minatomirai.MotomachiChukagai" )
        }
      }
    = ::TravelTimeInfoDecorator.render_travel_time_info_through_operation_info(h)
    HAML
  ...
  %td{ class: :through_operation_infos }<
    :ruby
      h = {
        from: wakoshi ,
        direction: [
          ::Station.find_by_same_as( "odpt.Station:Tobu.Tojo.Kawagoe" )
        ] ,
        railway_line_and_terminal_station: {
          railway_line: ::RailwayLine.find_by_same_as( "odpt.Railway:Tobu.Tojo" ) ,
          terminal_station: ::Station.find_by_same_as( "odpt.Station:Tobu.Tojo.ShinrinKoen" )
        }
      }
    = ::TravelTimeInfoDecorator.render_travel_time_info_through_operation_info(h)
  ...
  %td{ class: :through_operation_infos }<
    :ruby
      h = {
        ...
        direction: [
          ::Station.find_by_same_as( "odpt.Station:Seibu.Yurakucho.Nerima" ) ,
          ::Station.find_by_same_as( "odpt.Station:Seibu.Ikebukuro.Tokorozawa" )
        ] ,
        railway_line_and_terminal_station: {
          railway_line: ::RailwayLine.find_by_same_as( "odpt.Railway:Seibu.Ikebukuro" ) ,
          terminal_station: ::Station.find_by_same_as( "odpt.Station:Seibu.Ikebukuro.Hanno" )
        }
      }
    = ::TravelTimeInfoDecorator.render_travel_time_info_through_operation_info(h)
      HAML
