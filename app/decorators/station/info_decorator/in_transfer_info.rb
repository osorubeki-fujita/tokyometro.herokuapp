...
%div{ class: :another_station }
  %div{ class: :text_ja }<
    = d.render_name_ja( with_subname: false , suffix: decorator.object.attribute_ja )
  %div{ class: :text_en }<
    = d.render_name_en( with_subname: false , suffix: decorator.object.attribute_en_short.capitalize )
    HAML
  end
